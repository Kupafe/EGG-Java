...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        llenarMatriz10(matriz10);
        llenarMatriz3(matriz3);
        buscar(matriz10, matriz3);

    }
    
    // LLeno de vlores la Matriz de 10 x 10
    public static void llenarMatriz10(int [][]matriz10){
    
        matriz10[0][0] =  1; matriz10[0][1] = 26; matriz10[0][2] = 36; matriz10[0][3] = 00/*47*/; matriz10[0][4] =  5; matriz10[0][5] =  6; matriz10[0][6] = 72; matriz10[0][7] = 81; matriz10[0][8] = 95; matriz10[0][9] = 10;
        matriz10[1][0] = 11; matriz10[1][1] = 12; matriz10[1][2] = 13; matriz10[1][3] = 21; matriz10[1][4] = 41; matriz10[1][5] = 22; matriz10[1][6] = 67; matriz10[1][7] = 20; matriz10[1][8] = 10; matriz10[1][9] = 61;
        matriz10[2][0] = 56; matriz10[2][1] = 78; matriz10[2][2] = 87; matriz10[2][3] = 90; matriz10[2][4] =  9; matriz10[2][5] = 90; matriz10[2][6] = 17; matriz10[2][7] = 12; matriz10[2][8] = 87; matriz10[2][9] = 67;
        matriz10[3][0] = 41; matriz10[3][1] = 87; matriz10[3][2] = 24; matriz10[3][3] = 56; matriz10[3][4] = 97; matriz10[3][5] = 74; matriz10[3][6] = 87; matriz10[3][7] = 42; matriz10[3][8] = 64; matriz10[3][9] = 35;
        matriz10[4][0] = 32; matriz10[4][1] = 76; matriz10[4][2] = 79; matriz10[4][3] =  1; matriz10[4][4] = 36; matriz10[4][5] =  5; matriz10[4][6] = 67; matriz10[4][7] = 96; matriz10[4][8] = 12; matriz10[4][9] = 11;
        matriz10[5][0] = 99; matriz10[5][1] = 13; matriz10[5][2] = 54; matriz10[5][3] = 88; matriz10[5][4] = 89; matriz10[5][5] = 90; matriz10[5][6] = 75; matriz10[5][7] = 12; matriz10[5][8] = 41; matriz10[5][9] = 76;
        matriz10[6][0] = 67; matriz10[6][1] = 78; matriz10[6][2] = 87; matriz10[6][3] = 45; matriz10[6][4] = 14; matriz10[6][5] = 22; matriz10[6][6] = 26; matriz10[6][7] = 42; matriz10[6][8] = 56; matriz10[6][9] = 78;
        matriz10[7][0] = 98; matriz10[7][1] = 45; matriz10[7][2] = 34; matriz10[7][3] = 23; matriz10[7][4] = 32; matriz10[7][5] = 56; matriz10[7][6] = 74; matriz10[7][7] = 16; matriz10[7][8] = 19; matriz10[7][9] = 18;
        matriz10[8][0] = 24; matriz10[8][1] = 67; matriz10[8][2] = 97; matriz10[8][3] = 46; matriz10[8][4] = 87; matriz10[8][5] = 13; matriz10[8][6] = 67; matriz10[8][7] = 89; matriz10[8][8] = 93; matriz10[8][9] = 24;
        matriz10[9][0] = 21; matriz10[9][1] = 68; matriz10[9][2] = 78; matriz10[9][3] = 98; matriz10[9][4] = 90; matriz10[9][5] = 67; matriz10[9][6] = 12; matriz10[9][7] = 41; matriz10[9][8] = 65; matriz10[9][9] = 12;
        
        System.out.println("\nMOSTRAR MATRIZ 10 X 10.\n");
        mostrarMatriz(matriz10, 10);
    }
    
    // LLeno de vlores la Matriz de 3 x 3
    public static void llenarMatriz3(int [][]matriz3){
    
        matriz3[0][0] = 36; matriz3[0][1] =  5; matriz3[0][2] = 67;
        matriz3[1][0] = 89; matriz3[1][1] = 90; matriz3[1][2] = 75;
        matriz3[2][0] = 14; matriz3[2][1] = 22; matriz3[2][2] = 26;   
    ...
    // Buscar Primer numero de la matriz 3 en la matriz 10
    public static void buscar(int[][] matriz10, int[][] matriz3){
        ...
        for (int i = 0; i < 10; i++) {
            ...
            for (int j = 0; j < 10; j++) {
                ...
                if(matriz10[i][j] == matriz3[0][0]){
                    ...
                    //encontroNumero = true;
                    existeSecuencia(matriz10, matriz3, i, j);
                    //Ubicar secuencia
                }
    ...
    public static boolean existeSecuencia(int[][] matriz10, int[][] matriz3, int posicionI, int posicionJ){
        
        boolean encontroSecuencia = true;
        int pJ = posicionJ, pI = posicionI;
