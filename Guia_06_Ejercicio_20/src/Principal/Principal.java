...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        boolean filasIguales, columnasIguales, diagonalesIguales;
        ...
        filasIguales = compararFilasColumnasDiagonales(fila0, fila1, fila2);
        
        columnasIguales = compararFilasColumnasDiagonales(columna0, columna1, columna2);
        
        diagonalesIguales = compararFilasColumnasDiagonales(diagonalPrimaria, diagonalSecundaria, 15);
        
        if (filasIguales == true && columnasIguales == true && diagonalesIguales == true){
    ...
    public static boolean compararFilasColumnasDiagonales(int a, int b, int c){
